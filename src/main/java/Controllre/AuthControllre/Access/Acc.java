...
public class Acc {
    ...
    public ResponseEntity<Map<String,Object>> accessFromRefresh(@RequestParam("token") String refreshToken,@RequestHeader("Authorization") String ss){
    ...
    public ResponseEntity<Map<String,Object>> verifyAccess(@RequestHeader("Authorization") String accessToken){
    ...
    public ResponseEntity<Map<String,Object>> blacklistAccess(@RequestHeader("Authorization") String accessToken){
        if(accessToken.startsWith("Bearer ")){
            accessToken = accessToken.substring(7);
    ...
    public ResponseEntity<Map<String,Object>> blacklistRefresh(@RequestParam("token") String refreshToken){
        RefreshTokens refreshTokens = tokenResposteyrs.findByToken(refreshToken).orElseThrow(()->new RuntimeException("Refresh Token Not found"));
    ...
    public ResponseEntity<Map<String,Object>> logoutUser(@RequestHeader("Authorization") String accessToken){
        if(accessToken.startsWith("Bearer ")){
            accessToken = accessToken.substring(7);
    ...
    public ResponseEntity<Map<String,Object>> getUserFromAccess(@RequestHeader("Authorization") String accessToken){
        if(accessToken.startsWith("Bearer ")){
            accessToken = accessToken.substring(7);
            String username = mainJwts.getUsernameFromAccessToken(accessToken);
            return ResponseEntity.ok(Map.of(
